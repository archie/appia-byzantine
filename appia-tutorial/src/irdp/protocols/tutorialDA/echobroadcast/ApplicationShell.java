 ...
 * 
 * @author Jose Mocito, adaptation by EMDC
 * @version 1.0
 */
public class ApplicationShell implements Runnable {
     ...
     * @param ch
     */
	public ApplicationShell(Channel ch) {
		channel = ch;
	}
	...
	public void run() {
		...
		while(dontExit) {
			...
			EchoBroadcastEvent event = new EchoBroadcastEvent ();
			event.setText(str);
